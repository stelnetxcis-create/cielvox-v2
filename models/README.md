...
You can now use it like this:
  ...
  $ ./build/bin/stelnet -m models/ggml-base.en.bin -f samples/jfk.wav
```
...
python3 ./stelnet/models/convert-h5-to-ggml.py ./whisper-medium/ ./openai-whisper .
```
...
Currently, the chunk-based transcription strategy is not implemented, so there can be sub-optimal quality when using the distilled models with `stelnet`.

```bash
# clone OpenAI whisper and stelnet
git clone https://github.com/openai/whisper
git clone https://github.com/CrispStrobe/Stelnet
