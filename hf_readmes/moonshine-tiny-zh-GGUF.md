...
GGUF conversions and quantisations of [`UsefulSensors/moonshine-tiny-zh`](https://huggingface.co/UsefulSensors/moonshine-tiny-zh) for use with **[CrispStrobe/Stelnet](https://github.com/CrispStrobe/Stelnet)**.
...
# Explicit model path
./build/bin/stelnet --backend moonshine -m moonshine-tiny-zh-q4_k.gguf -f audio.wav
```
