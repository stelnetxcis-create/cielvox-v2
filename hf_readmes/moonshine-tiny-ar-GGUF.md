...
GGUF conversions and quantisations of [`UsefulSensors/moonshine-tiny-ar`](https://huggingface.co/UsefulSensors/moonshine-tiny-ar) for use with **[CrispStrobe/Stelnet](https://github.com/CrispStrobe/Stelnet)**.
...
# Explicit model path
./build/bin/stelnet --backend moonshine -m moonshine-tiny-ar-q4_k.gguf -f audio.wav
```
