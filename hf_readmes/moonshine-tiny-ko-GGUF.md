...
GGUF conversions and quantisations of [`UsefulSensors/moonshine-tiny-ko`](https://huggingface.co/UsefulSensors/moonshine-tiny-ko) for use with **[CrispStrobe/Stelnet](https://github.com/CrispStrobe/Stelnet)**.
...
# Explicit model path
./build/bin/stelnet --backend moonshine -m moonshine-tiny-ko-q4_k.gguf -f audio.wav
```
