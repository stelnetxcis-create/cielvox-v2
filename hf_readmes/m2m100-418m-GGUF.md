...
GGUF / ggml conversion of [`facebook/m2m100_418M`](https://huggingface.co/facebook/m2m100_418M) for use with **[CrispStrobe/Stelnet](https://github.com/CrispStrobe/Stelnet)**.
...
./build/bin/stelnet --backend m2m100 -m m2m100-418m-q8_0.gguf \
...
# Auto-download (registered in src/stelnet_model_registry.cpp):
