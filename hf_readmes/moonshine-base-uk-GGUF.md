...
GGUF conversions and quantisations of [`UsefulSensors/moonshine-base-uk`](https://huggingface.co/UsefulSensors/moonshine-base-uk) for use with **[CrispStrobe/Stelnet](https://github.com/CrispStrobe/Stelnet)**.
...
# Explicit model path
./build/bin/stelnet --backend moonshine -m moonshine-base-uk-q4_k.gguf -f audio.wav
```
