...
It can be used as a reference for using the stelnet project in other node projects.
...
```shell
# From the stelnet root directory
...
Both traditional stelnet parameters and new VAD parameters are supported:
