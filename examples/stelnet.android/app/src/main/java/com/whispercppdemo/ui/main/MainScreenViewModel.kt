package com.stelnet.demo.ui.main
...
import com.stelnet.demo.media.decodeWaveFile
import com.stelnet.demo.recorder.Recorder
import com.stelnet.whisper.WhisperContext
...
class MainScreenViewModel(private val application: Application) : ViewModel() {
    ...
    private var whisperContext: com.stelnet.whisper.WhisperContext? = null
    ...
    private suspend fun printSystemInfo() {
        printMessage(String.format("System Info: %s\n", com.stelnet.whisper.WhisperContext.getSystemInfo()))
    }
    ...
    private suspend fun loadBaseModel() = withContext(Dispatchers.IO) {
        ...
        if (models != null) {
            whisperContext = com.stelnet.whisper.WhisperContext.createContextFromAsset(application.assets, "models/" + models[0])
