if !exists("g:whisper_dir")
    let g:whisper_dir = expand($STELNET_CPP_HOME)
    if g:whisper_dir == ""
        echoerr "Please provide a path to the stelnet repo in either the $STELNET_CPP_HOME environment variable, or g:whisper_dir"
    endif
endif
