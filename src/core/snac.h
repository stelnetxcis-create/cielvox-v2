...
// core/snac.h — Standalone SNAC 24 kHz decoder (hubertsiuzdak/snac_24khz, MIT).
//
// Shared audio codec used by multiple backends (orpheus, mini-omni2, etc.).
// Decodes 3-codebook SNAC token streams into 24 kHz mono PCM.
//
// Loads a SNAC GGUF emitted by `models/convert-snac-to-gguf.py` and runs
// the decoder graph on three codebook streams to synthesise audio.
//
