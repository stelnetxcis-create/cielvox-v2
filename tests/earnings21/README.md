...
stelnet on Earnings-21 corpus.

## Quick Start

1. (Pre-requirement) Compile `stelnet` and prepare the Whisper
   ...
   Consult [stelnet/README.md](../../README.md) for more details.
...
```
STELNET_MODEL = large-v3-turbo
STELNET_FLAGS = --no-prints --threads 8 --language en --output-txt
```
...
```
STELNET_FLAGS = --no-prints --language en --output-txt --vad --vad-model ../../models/ggml-silero-v6.2.0.bin
```
