...
<!-- Source of truth: `stelnet --list-backends-json`. -->

# Feature matrix

All 76 backends compiled into the `stelnet` binary, with their declared capability bits. For an interactive sortable/filterable view, open [`feature-matrix.html`](feature-matrix.html).
