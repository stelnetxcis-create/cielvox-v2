...
/*
// Static linking of libstelnet.a requires every conditionally-built sub-lib
...
// new target_link_libraries(stelnet PUBLIC <X>) in src/CMakeLists.txt, re-run
// the sync script to update these lines automatically.
#cgo CFLAGS: -I${SRCDIR}/../../include -I${SRCDIR}/../../ggml/include
#cgo LDFLAGS: -L${SRCDIR}/../../build-ninja-compile/src -L${SRCDIR}/../../build-ninja-compile/stelnet_audio -L${SRCDIR}/../../build-ninja-compile/stelnet_lid -L${SRCDIR}/../../build-ninja-compile/stelnet_punc -L${SRCDIR}/../../build-ninja-compile/stelnet_truecase -L${SRCDIR}/../../build-ninja-compile/ggml/src
#cgo LDFLAGS: -L${SRCDIR}/../../build/src -L${SRCDIR}/../../build/stelnet_audio -L${SRCDIR}/../../build/stelnet_lid -L${SRCDIR}/../../build/stelnet_punc -L${SRCDIR}/../../build/stelnet_truecase -L${SRCDIR}/../../build/ggml/src
#cgo LDFLAGS: -L${SRCDIR}/../../build_go/src -L${SRCDIR}/../../build_go/stelnet_audio -L${SRCDIR}/../../build_go/stelnet_lid -L${SRCDIR}/../../build_go/stelnet_punc -L${SRCDIR}/../../build_go/stelnet_truecase -L${SRCDIR}/../../build_go/ggml/src
...
#cgo linux LDFLAGS: -Wl,--start-group -lggml-base -lggml-cpu -lggml -lstelnet-core -ltada-codec -lstelnet_audio -lsnac -lmoonshine_tokenizer -lmimo_tokenizer -lbert-encoder -lfirered-asr -lzonos-tts -lwav2vec2-ggml -lvoxtral4b -lvoxtral -lvoxcpm2_tts -lvibevoice -ltitanet -ltada-tts -lt5_translate -lspeecht5-tts -lsilero-lid -lsensevoice -lqwen3_tts -lqwen3_asr -lpyannote-seg -lpocket-tts -lpiper-tts -lparler-tts -lparakeet -lparaformer -loutetts -lorpheus -lopenvoice2 -lomniasr -lnemotron -lmoss_audio -lmoonshine_streaming -lmoonshine -lmini-omni2 -lmimo_asr -lmelotts -lmarblenet-vad -lm2m100 -llfm2_audio -lkyutai-stt -lkugelaudio -lkokoro -lindextts -lgranite_speech -lgranite_nle -lglm-asr -lgemma4_e2b -lfunasr -lfirered-vad -lfirered-lid -lfastpitch-tts -lf5-tts -lecapa-lid -ldia-tts -lctc-align -lcsm-tts -lstelnet-vad-encdec -lstelnet-llama-core -lstelnet_truecase -lstelnet_punc -lstelnet_lid -lcosyvoice3_tts -lcohere -lchatterbox -lcanary_ctc -lcanary -lbark-tts -laudioseal -lstelnet -Wl,--end-group -lm -lstdc++ -fopenmp
#cgo darwin LDFLAGS: -lggml-base -lggml-cpu -lggml -lstelnet-core -ltada-codec -lstelnet_audio -lsnac -lmoonshine_tokenizer -lmimo_tokenizer -lbert-encoder -lfirered-asr -lzonos-tts -lwav2vec2-ggml -lvoxtral4b -lvoxtral -lvoxcpm2_tts -lvibevoice -ltitanet -ltada-tts -lt5_translate -lspeecht5-tts -lsilero-lid -lsensevoice -lqwen3_tts -lqwen3_asr -lpyannote-seg -lpocket-tts -lpiper-tts -lparler-tts -lparakeet -lparaformer -loutetts -lorpheus -lopenvoice2 -lomniasr -lnemotron -lmoss_audio -lmoonshine_streaming -lmoonshine -lmini-omni2 -lmimo_asr -lmelotts -lmarblenet-vad -lm2m100 -llfm2_audio -lkyutai-stt -lkugelaudio -lkokoro -lindextts -lgranite_speech -lgranite_nle -lglm-asr -lgemma4_e2b -lfunasr -lfirered-vad -lfirered-lid -lfastpitch-tts -lf5-tts -lecapa-lid -ldia-tts -lctc-align -lcsm-tts -lstelnet-vad-encdec -lstelnet-llama-core -lstelnet_truecase -lstelnet_punc -lstelnet_lid -lcosyvoice3_tts -lcohere -lchatterbox -lcanary_ctc -lcanary -lbark-tts -laudioseal -lstelnet -lm -lstdc++
...
const (
	SAMPLING_GREEDY      SamplingStrategy = C.STELNET_SAMPLING_GREEDY
	SAMPLING_BEAM_SEARCH SamplingStrategy = C.STELNET_SAMPLING_BEAM_SEARCH
)

const (
	SampleRate = C.STELNET_SAMPLE_RATE                 // Expected sample rate, samples per second
	SampleBits = uint16(unsafe.Sizeof(C.float(0))) * 8 // Sample size in bits
	NumFFT     = C.STELNET_N_FFT
	HopLength  = C.STELNET_HOP_LENGTH
	ChunkSize  = C.STELNET_CHUNK_SIZE
)
...
// Added to stelnet in
// https://github.com/CrispStrobe/Stelnet/commit/a1c1583cc7cd8b75222857afc936f0638c5683d6
//
// Examples:
//
//	"de" -> 2
