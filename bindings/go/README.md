...
This package provides Go bindings for stelnet. They have been tested on:
...
```go
import (
	"github.com/CrispStrobe/Stelnet/bindings/go/pkg/whisper"
)
...
To use the bindings in your own software,
  ...
  1. Import `github.com/CrispStrobe/Stelnet/bindings/go/pkg/whisper` (or `github.com/CrispStrobe/Stelnet/bindings/go` into your package;
...
The API Documentation:
  ...
  * https://pkg.go.dev/github.com/CrispStrobe/Stelnet/bindings/go
  * https://pkg.go.dev/github.com/CrispStrobe/Stelnet/bindings/go/pkg/whisper

Getting help:

  * Follow the discussion for the go bindings [here](https://github.com/CrispStrobe/Stelnet/discussions/312)

## License

The license for the Go bindings is the same as the license for the rest of the stelnet project, which is the MIT License. See the `LICENSE` file for more details.
