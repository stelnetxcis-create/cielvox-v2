...
class WhisperCppTest {
    ...
    static void init() throws FileNotFoundException {
        ...
        try {
            ...
            //whisper.getFullDefaultParams(WhisperSamplingStrategy.STELNET_SAMPLING_GREEDY);
            //whisper.getJavaDefaultParams(WhisperSamplingStrategy.STELNET_SAMPLING_BEAM_SEARCH);
    ...
    void testGetDefaultFullParams_BeamSearch() {
        // When
        WhisperFullParams params = whisper.getFullDefaultParams(WhisperSamplingStrategy.STELNET_SAMPLING_BEAM_SEARCH);

        // Then
        assertEquals(WhisperSamplingStrategy.STELNET_SAMPLING_BEAM_SEARCH.ordinal(), params.strategy);
    ...
    void testGetDefaultFullParams_Greedy() {
        // When
        WhisperFullParams params = whisper.getFullDefaultParams(WhisperSamplingStrategy.STELNET_SAMPLING_GREEDY);

        // Then
        assertEquals(WhisperSamplingStrategy.STELNET_SAMPLING_GREEDY.ordinal(), params.strategy);
        assertNotEquals(0, params.n_threads);
        assertEquals(16384, params.n_max_text_ctx);
    ...
    void testFullTranscribe() throws Exception {
        ...
        //WhisperFullParams params = whisper.getFullDefaultParams(WhisperSamplingStrategy.STELNET_SAMPLING_GREEDY);
        WhisperFullParams.ByValue params = whisper.getFullDefaultParams(WhisperSamplingStrategy.STELNET_SAMPLING_BEAM_SEARCH);
