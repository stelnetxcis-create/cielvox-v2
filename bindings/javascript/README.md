...
Node.js package for Stelnet speech recognition

Package: https://www.npmjs.com/package/stelnet

## Details

The performance is comparable to when running `stelnet` in the browser via WASM.

The API is currently very rudimentary: [bindings/javascript/emscripten.cpp](/bindings/javascript/emscripten.cpp)

For sample usage check [tests/test-stelnet.js](/Users/christianstrobele/code/Stelnet/tests/test-stelnet.js)
...
# run test
node ../tests/test-stelnet.js

# For Node.js versions prior to v16.4.0, experimental features need to be enabled:
node --experimental-wasm-threads --experimental-wasm-simd ../tests/test-stelnet.js
