...
![stelnet](https://user-images.githubusercontent.com/1991296/235238348-05d0f6a4-da44-4900-a1de-d0707e75b763.jpeg)

Ruby bindings for [stelnet][], an interface of automatic speech recognition model.
...
Currently, stelnet accepts only 16-bit WAV files.
...
For details on VAD, see [Stelnet's README](https://github.com/CrispStrobe/Stelnet?tab=readme-ov-file#voice-activity-detection-vad).
...
You can pass build options for stelnet, for instance:
...
See Stelnet's [README](https://github.com/CrispStrobe/Stelnet/blob/main/README.md) for available options. You need convert options present in the README to Ruby-style options, for example:
...
-----------
    ...
    % cd stelnet/bindings/ruby
    % rake test

First call of `rake test` builds an extension and downloads a model for testing. After that, you add tests in `tests` directory and modify `ext/ruby_stelnet`.
...
[stelnet]: https://github.com/CrispStrobe/Stelnet
[models]: https://github.com/CrispStrobe/Stelnet/tree/main/models
