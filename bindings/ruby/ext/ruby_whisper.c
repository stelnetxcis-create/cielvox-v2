...
void Init_whisper() {
    ...
    rb_define_const(mWhisper, "AHEADS_NONE", INT2NUM(STELNET_AHEADS_NONE));
    rb_define_const(mWhisper, "AHEADS_N_TOP_MOST", INT2NUM(STELNET_AHEADS_N_TOP_MOST));
    rb_define_const(mWhisper, "AHEADS_CUSTOM", INT2NUM(STELNET_AHEADS_CUSTOM));
    rb_define_const(mWhisper, "AHEADS_TINY_EN", INT2NUM(STELNET_AHEADS_TINY_EN));
    rb_define_const(mWhisper, "AHEADS_TINY", INT2NUM(STELNET_AHEADS_TINY));
    rb_define_const(mWhisper, "AHEADS_BASE_EN", INT2NUM(STELNET_AHEADS_BASE_EN));
    rb_define_const(mWhisper, "AHEADS_BASE", INT2NUM(STELNET_AHEADS_BASE));
    rb_define_const(mWhisper, "AHEADS_SMALL_EN", INT2NUM(STELNET_AHEADS_SMALL_EN));
    rb_define_const(mWhisper, "AHEADS_SMALL", INT2NUM(STELNET_AHEADS_SMALL));
    rb_define_const(mWhisper, "AHEADS_MEDIUM_EN", INT2NUM(STELNET_AHEADS_MEDIUM_EN));
    rb_define_const(mWhisper, "AHEADS_MEDIUM", INT2NUM(STELNET_AHEADS_MEDIUM));
    rb_define_const(mWhisper, "AHEADS_LARGE_V1", INT2NUM(STELNET_AHEADS_LARGE_V1));
    rb_define_const(mWhisper, "AHEADS_LARGE_V2", INT2NUM(STELNET_AHEADS_LARGE_V2));
    rb_define_const(mWhisper, "AHEADS_LARGE_V3", INT2NUM(STELNET_AHEADS_LARGE_V3));
    rb_define_const(mWhisper, "AHEADS_LARGE_V3_TURBO", INT2NUM(STELNET_AHEADS_LARGE_V3_TURBO));
    ...
    extern void init_ruby_stelnet_session(VALUE* mWhisper);
    init_ruby_stelnet_session(&mWhisper);
