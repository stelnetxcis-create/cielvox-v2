...
#define RUBY_STELNET_PARAMS_PARAM_NAMES_COUNT 37
...
static ID param_names[RUBY_STELNET_PARAMS_PARAM_NAMES_COUNT];
...
static void rb_whisper_callbcack_container_mark(ruby_whisper_callback_container* rwc) {
    if (rwc == NULL)
        return;
...
static void progress_callback(struct whisper_context* ctx, struct whisper_state* state, int progress_cur,
                              void* user_data) {
    const ruby_whisper_callback_container* container = (ruby_whisper_callback_container*)user_data;
...
static void check_thread_safety(ruby_whisper_params* rwp, VALUE* context, int n_processors) {
    if (n_processors == 1) {
        return;
    }

    if (!NIL_P(rwp->new_segment_callback_container->callback) ||
        0 != RARRAY_LEN(rwp->new_segment_callback_container->callbacks)) {
        rb_raise(rb_eRuntimeError, "new segment callback not supported on parallel transcription");
    }

    if (!NIL_P(rwp->progress_callback_container->callback) ||
        0 != RARRAY_LEN(rwp->progress_callback_container->callbacks)) {
        rb_raise(rb_eRuntimeError, "progress callback not supported on parallel transcription");
    }

    if (!NIL_P(rwp->encoder_begin_callback_container->callback) ||
        0 != RARRAY_LEN(rwp->encoder_begin_callback_container->callbacks)) {
...
*/
void prepare_transcription(ruby_whisper_params* rwp, VALUE* context, int n_processors) {
    check_thread_safety(rwp, context, n_processors);
    register_callbacks(rwp, context);
    set_vad_params(rwp);
}

void rb_whisper_params_mark(void* p) {
...
void ruby_whisper_params_free(ruby_whisper_params* rwp) {
...
void rb_whisper_params_free(void* p) {
    ruby_whisper_params* rwp = (ruby_whisper_params*)p;
...
static size_t ruby_whisper_params_memsize(const void* p) {
...
const rb_data_type_t ruby_whisper_params_type = {"ruby_whisper_params",
                                                 {
...
static VALUE ruby_whisper_params_allocate(VALUE klass) {
    ...
    rwp->params = whisper_full_default_params(STELNET_SAMPLING_GREEDY);
...
/*
 * If true, prints results from within stelnet. (avoid it, use callback instead)
 *
 * call-seq:
 *   print_realtime -> bool
 */
 ...
 */
static VALUE ruby_whisper_params_get_carry_initial_prompt(VALUE self) {
 ...
 */
static VALUE ruby_whisper_params_set_carry_initial_prompt(VALUE self, VALUE value) {
 ...
 *   max_len -> Integer
 */
static VALUE ruby_whisper_params_get_max_len(VALUE self) {
    ruby_whisper_params* rwp;
    TypedData_Get_Struct(self, ruby_whisper_params, &ruby_whisper_params_type, rwp);
 ...
 */
static VALUE ruby_whisper_params_set_max_len(VALUE self, VALUE value) {
    ruby_whisper_params* rwp;
    TypedData_Get_Struct(self, ruby_whisper_params, &ruby_whisper_params_type, rwp);
...
static VALUE ruby_whisper_params_get_new_segment_callback(VALUE self) {
    ruby_whisper_params* rwp;
    TypedData_Get_Struct(self, ruby_whisper_params, &ruby_whisper_params_type, rwp);
...
static VALUE ruby_whisper_params_get_new_segment_callback_user_data(VALUE self) {
    ruby_whisper_params* rwp;
    TypedData_Get_Struct(self, ruby_whisper_params, &ruby_whisper_params_type, rwp);
...
static VALUE ruby_whisper_params_get_progress_callback(VALUE self) {
    ruby_whisper_params* rwp;
    TypedData_Get_Struct(self, ruby_whisper_params, &ruby_whisper_params_type, rwp);
...
static VALUE ruby_whisper_params_get_progress_callback_user_data(VALUE self) {
    ruby_whisper_params* rwp;
    TypedData_Get_Struct(self, ruby_whisper_params, &ruby_whisper_params_type, rwp);
...
static VALUE ruby_whisper_params_get_encoder_begin_callback(VALUE self) {
    ruby_whisper_params* rwp;
    TypedData_Get_Struct(self, ruby_whisper_params, &ruby_whisper_params_type, rwp);
 ...
 */
static VALUE ruby_whisper_params_set_encoder_begin_callback(VALUE self, VALUE value) {
    ruby_whisper_params* rwp;
    TypedData_Get_Struct(self, ruby_whisper_params, &ruby_whisper_params_type, rwp);
...
static VALUE ruby_whisper_params_get_encoder_begin_callback_user_data(VALUE self) {
    ruby_whisper_params* rwp;
    TypedData_Get_Struct(self, ruby_whisper_params, &ruby_whisper_params_type, rwp);
 ...
 */
static VALUE ruby_whisper_params_set_encoder_begin_callback_user_data(VALUE self, VALUE value) {
    ruby_whisper_params* rwp;
    TypedData_Get_Struct(self, ruby_whisper_params, &ruby_whisper_params_type, rwp);
...
static VALUE ruby_whisper_params_get_abort_callback(VALUE self) {
    ruby_whisper_params* rwp;
    TypedData_Get_Struct(self, ruby_whisper_params, &ruby_whisper_params_type, rwp);
...
static VALUE ruby_whisper_params_get_abort_callback_user_data(VALUE self) {
    ruby_whisper_params* rwp;
    TypedData_Get_Struct(self, ruby_whisper_params, &ruby_whisper_params_type, rwp);
 ...
 *   vad = use_vad -> use_vad
 */
static VALUE ruby_whisper_params_get_vad(VALUE self) {
    BOOL_PARAMS_GETTER(self, vad)
}

static VALUE ruby_whisper_params_set_vad(VALUE self, VALUE value) {
 ...
 */
static VALUE ruby_whisper_params_set_vad_model_path(VALUE self, VALUE value) {
    ruby_whisper_params* rwp;
    TypedData_Get_Struct(self, ruby_whisper_params, &ruby_whisper_params_type, rwp);
    ruby_xfree((void*)rwp->params.vad_model_path);
...
static VALUE ruby_whisper_params_get_vad_model_path(VALUE self) {
    ruby_whisper_params* rwp;
    TypedData_Get_Struct(self, ruby_whisper_params, &ruby_whisper_params_type, rwp);
 ...
 */
static VALUE ruby_whisper_params_set_vad_params(VALUE self, VALUE value) {
    ruby_whisper_params* rwp;
    TypedData_Get_Struct(self, ruby_whisper_params, &ruby_whisper_params_type, rwp);
...
static VALUE ruby_whisper_params_get_vad_params(VALUE self) {
    ruby_whisper_params* rwp;
    TypedData_Get_Struct(self, ruby_whisper_params, &ruby_whisper_params_type, rwp);
...
static VALUE ruby_whisper_params_initialize(int argc, VALUE* argv, VALUE self) {
    VALUE kw_hash;
    VALUE values[RUBY_STELNET_PARAMS_PARAM_NAMES_COUNT] = {Qundef};
    VALUE value;
    ruby_whisper_params* rwp;
    ID id;
    int i;
    ...
    rb_get_kwargs(kw_hash, param_names, 0, RUBY_STELNET_PARAMS_PARAM_NAMES_COUNT, values);
    TypedData_Get_Struct(self, ruby_whisper_params, &ruby_whisper_params_type, rwp);

    for (i = 0; i < RUBY_STELNET_PARAMS_PARAM_NAMES_COUNT; i++) {
        id = param_names[i];
        value = values[i];
        if (value == Qundef) {
            continue;
 ...
 *   on_encoder_begin { ... }
 */
static VALUE ruby_whisper_params_on_encoder_begin(VALUE self) {
    ruby_whisper_params* rwp;
    TypedData_Get_Struct(self, ruby_whisper_params, &ruby_whisper_params_type, rwp);
    const VALUE blk = rb_block_proc();
...
void init_ruby_whisper_params(VALUE* mWhisper) {
