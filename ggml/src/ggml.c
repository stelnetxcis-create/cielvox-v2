...
struct ggml_tensor * ggml_conv_1d(
        ...
        int                   p0,
        int                   d0) {
    // Stelnet fork (issue #38 companion): pick im2col output type based on
...
struct ggml_tensor * ggml_conv_1d_dw(
    ...
    // Stelnet fork (issue #38 companion): same im2col-type handling as
...
// ggml_aa_snake_beta
//
// Stelnet patch (PR #07-metal-aa-snake-beta): fused BigVGAN v2 anti-aliased
...
struct ggml_tensor * ggml_conv_2d(
        ...
        int                   d0,
        int                   d1) {
    // Stelnet fork (issue #38 companion): pick im2col output type the
