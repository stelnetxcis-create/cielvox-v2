...
// Stelnet patch (#83): kargs for Q8_K input quantize + Q4_K×Q8_K matmul.
...
// Stelnet patch (#83 r9): kargs for Q8_0 input quantize + Q8_0×Q8_0 matmul.
...
// Stelnet patch (PR #160 col2im_1d decomposition): kargs for the
...
// Stelnet patch (PR #07-metal-aa-snake-beta): kargs for the fused
