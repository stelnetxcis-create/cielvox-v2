...
echo "int STELNET_BUILD_NUMBER = ${build_number};"
echo "char const *STELNET_COMMIT = \"${build_commit}\";"
echo "char const *STELNET_COMPILER = \"${build_compiler}\";"
echo "char const *STELNET_BUILD_TARGET = \"${build_target}\";"
