...
In addition to [Github Actions](https://github.com/CrispStrobe/Stelnet/actions) `stelnet` uses a custom CI framework:

https://github.com/ggml-org/ci

It monitors the `master` branch for new commits and runs the
[ci/run.sh](https://github.com/CrispStrobe/Stelnet/blob/main/ci/run.sh) script on dedicated cloud instances. This allows us
